...
const translations: Record<Language, Record<string, string>> = {
  ...
  en: {
    ...
    tagline: "Autonomous Enterprise Governance v1.2",
    ...
    mail_inbox: "Corp-Comm Inbox",
    mail_composer: "Draft Manifest",
    queue: "Task Queue",
  ...
  zh: {
    ...
    tagline: "自治企业治理系统 v1.2",
    agent_team: "活跃代理人执行团队",
    decision_log: "决策智能信息流",
    intelligence_log: "情报日志",
    mail_inbox: "企业通讯",
    mail_composer: "起草方案",
    queue: "任务队列",
    kpi_dscr: "DSCR (财务安全线)",
  ...
  ru: {
    ...
    tagline: "Система автономного управления v1.2",
    agent_team: "Активная группа агентов",
    decision_log: "Лента принятия решений",
    intelligence_log: "Журнал анализа",
    mail_inbox: "Корп. почта",
    mail_composer: "Черновик",
    queue: "Очередь задач",
  ...
  es: {
    ...
    tagline: "Gobernanza Empresarial Autónoma v1.2",
    agent_team: "Equipo de Agentes Activos",
    decision_log: "Flujo de Inteligencia de Decisiones",
    intelligence_log: "Registro de Inteligencia",
    mail_inbox: "Buzón Corporativo",
    mail_composer: "Redactar Plan",
  ...
  ko: {
    ...
    tagline: "자율 기업 거버넌스 시스템 v1.2",
    agent_team: "액티브 에이전트 팀",
    decision_log: "의사 결정 인테리전스 피드",
    intelligence_log: "지능형 로그",
    mail_inbox: "기업 통신",
    mail_composer: "기획서 작성",
    queue: "작업 대기열",
  ...
  fr: {
    ...
    tagline: "Gouvernance d'Entreprise Autonome v1.2",
    agent_team: "Équipe d'Agents Actifs",
    decision_log: "Flux d'Intelligence Décisionnelle",
    intelligence_log: "Journal d'Intelligence",
    mail_inbox: "Boîte Corp-Comm",
    mail_composer: "Rédiger Manifeste",
